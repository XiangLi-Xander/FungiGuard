...
class biLSTMATTClassifier(nn.Module):
    ...
    def forward(self, x):
        ...
        output = output.permute(1, 0, 2) # 调整output的维度用于计算加权和
...
# new_data.to_excel('data/biLSTMATT_peps_with_predictions.xlsx', index=False)

# # 绘图
# plot_loss(loss_list,"fig/biLSTMATT_loss.png")
# plot_confusion(labels,predicted,"fig/biLSTMATT_confusion.png")
# plot_auc_curve(labels, probability, "fig/biLSTMATT_AUC.png")
